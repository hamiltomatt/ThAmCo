...
namespace ThAmCo.Events.Data.Migrations
{
    ...
    [Migration("20190110071238_AddCustomerAnonDelete")]
    partial class AddCustomerAnonDelete
    {
            ...
            modelBuilder.Entity("ThAmCo.Events.Data.Customer", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, Email = "bob@example.com", FirstName = "Robert", IsActive = true, Surname = "Robertson" },
                        new { Id = 2, Email = "betty@example.com", FirstName = "Betty", IsActive = true, Surname = "Thornton" },
                        new { Id = 3, Email = "jin@example.com", FirstName = "Jin", IsActive = true, Surname = "Jellybeans" }
                    );
                });
            ...
            modelBuilder.Entity("ThAmCo.Events.Data.Event", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, Date = new DateTime(2018, 12, 5, 0, 0, 0, 0, DateTimeKind.Unspecified), Duration = new TimeSpan(0, 6, 0, 0, 0), IsActive = true, Title = "Bob's Big 50", TypeId = "PTY" },
